...
<template>
    <nav class="bg-white border-b border-gray-100">
        ...
        <div class="flex h-16 max-w-7xl justify-between mx-auto px-4 sm:px-6 lg:px-8">
            <!-- Hamburger -->
            <div class="-me-2 flex items-center sm:hidden">
                <button
                    @click="showingNavigationDropdown = !showingNavigationDropdown"
                    class="inline-flex items-center justify-center p-2 rounded-md text-black hover:text-gray-800 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 focus:text-gray-500 transition duration-150 ease-in-out"
                >
        ...
        >
            <div class="pt-2 pb-3 space-y-1">
                <ResponsiveNavLink :href="route('admin.index')" :active="route().current('admin.dashboard')">
                    Dashboard
                </ResponsiveNavLink>
